...
IMG_PREFIX:=unitylinux-$(if $(CONFIG_VERSION_FILENAMES),$(VERSION_NUMBER)-)$(BOARD)$(if $(SUBTARGET),-$(SUBTARGET))
...
define Image/BuildKernel/MkuImage
	mkimage -A $(ARCH) -O linux -T kernel -C $(1) -a $(2) -e $(3) \
		-n '$(call toupper,$(ARCH)) Unity-Linux-$(LINUX_VERSION)' -d $(4) $(5)
endef
...
define Build/uImage
	mkimage -A $(LINUX_KARCH) \
		...
		-n '$(call toupper,$(LINUX_KARCH)) Unity-Linux-$(LINUX_VERSION)' -d $@ $@.new
	@mv $@.new $@
endef
