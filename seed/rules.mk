...
ifeq ($(CONFIG_EXTERNAL_TOOLCHAIN),)
  ...
  REAL_GNU_TARGET_NAME=$(OPTIMIZE_FOR_CPU)-unity-linux$(if $(TARGET_SUFFIX),-$(TARGET_SUFFIX))
  GNU_TARGET_NAME=$(OPTIMIZE_FOR_CPU)-unity-linux
...
ifndef DUMP
  ifeq ($(CONFIG_EXTERNAL_TOOLCHAIN),)
    ...
    TARGET_CROSS:=$(if $(TARGET_CROSS),$(TARGET_CROSS),$(OPTIMIZE_FOR_CPU)-unity-linux$(if $(TARGET_SUFFIX),-$(TARGET_SUFFIX))-)
